...
async def main(
    access_key, secret_key, paradigm_account_information,
    paradigm_ws_url, dbt_http_host, bit_http_host,
    paradigm_http_host, maker_desk_name,
):
    """
...
async def create_rfq_task(
    maker_desk_name, dbt_http_host, bit_http_host,
    ...
    while True:
        ...
        scenario_payload = {
            'account': {
                'name': paradigm_account_information['name']['DBT']
            },
            'anonymous': False,
            'client_order_id': random_client_order_id,
            'counterparties': [maker_desk_name],
        }
        scenario_payload_1 = scenario_payload | {
            'anonymous': True,
            'expires_in': 60,
            'legs': [
                {
        ...
        scenario_payload_2 = scenario_payload | {
            'expires_in': 80,
            'legs': [
                {
                    'quantity': 15000,
        ...
        scenario_payload_3 = scenario_payload | {
            'counterparties': [maker_desk_name],
            'expires_in': 60,
            'legs': [
                {
        ...
        scenario_payload_4 = scenario_payload | {
            'expires_in': 60,
            'legs': [
                {
                    'quantity': 45000,
        ...
        scenario_payload_5 = scenario_payload | {
            'expires_in': 65,
            'legs': [
                {
                    'quantity': 25,
        ...
        scenario_payload_6 = scenario_payload | {
            'expires_in': 65,
            'legs': [
                {
                    'quantity': 12.5,
        ...
        scenario_payload_7 = scenario_payload | {
            'expires_in': 65,
            'legs': [
                {
                    'quantity': 12.5,
        ...
        scenario_payload_8 = scenario_payload | {
            'expires_in': 65,
            'legs': [
                {
                    'quantity': 12.5,
        ...
        scenario_list = [
            scenario_payload_1, scenario_payload_2, scenario_payload_3,
            scenario_payload_4, scenario_payload_5, scenario_payload_6,
            scenario_payload_7, scenario_payload_8,
        ]
        await create_rfq(
            random.choice(scenario_list), dbt_http_host, bit_http_host,
            access_key, secret_key, paradigm_http_host,
        )
...
async def create_rfq(
    payload, dbt_http_host, bit_http_host,
    access_key, secret_key, paradigm_http_host,
):
    """
    ...
    response = requests.post(urljoin(paradigm_http_host, path), headers=headers, json=payload)
    return response
